...
`java -jar target/kafka-streams-interactive-query-advanced-0.0.1-SNAPSHOT.jar --server.port=8002 --spring.cloud.stream.kafka.streams.binder.configuration.application.server=localhost:8002'
